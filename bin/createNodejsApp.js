...
if (process.argv.length < 3) {
  ...
  console.log('    npx create-fastify-babel-app my-app');
  console.log('    OR');
  console.log('    npm init fastify-babel-app my-app');
  process.exit(1);
}
...
const repo = 'https://github.com/tguelcan/fastify-babel.git';
...
async function setup() {
  try {
    ...
    console.log();
    console.log('Enjoy your production-ready fastify app!');
